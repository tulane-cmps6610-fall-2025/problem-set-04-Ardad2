...
- The reason for this reason is that Fixed length uses B = $\lceil$\log_2 k \rceil$ bits per character for k distinct symbols whereas Huffman assigns shorter codes to the more frequent symbols.
