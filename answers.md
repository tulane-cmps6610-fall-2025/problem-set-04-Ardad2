...
- The reason for this reason is that Fixed length uses B = ceiling of $\log_2$ of k bits per character for k distinct symbols whereas Huffman assigns shorter codes to the more frequent symbols.
